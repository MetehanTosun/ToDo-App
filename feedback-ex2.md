...
Dein Projekt startet nich, aber die test würden laufen bitte sicherstellen dass bis zum AB3 Readme genauer ist und das Projekt läuft ohne Hilfe

| Kriterium                     | erreichte Punkte / maximale Punkte |
| ----------------------------- |------------------------------|
| Funktionalität der API        | 5 / 20                       |
...
- Suite `assignees.tests.js` (__ / 9,5 Punkte)
...
- Suite `todos.tests.js` (__ / 10,5 Punkte)
...
## Repository, Config und README (__ / 5)
